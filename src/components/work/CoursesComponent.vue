...
<template>
  <div class="group/Section mb-12" ref="coursesRef" tabindex="-1">
    <h2 class="mb-4 flex justify-between text-3xl">
      <span>Cursos</span>
